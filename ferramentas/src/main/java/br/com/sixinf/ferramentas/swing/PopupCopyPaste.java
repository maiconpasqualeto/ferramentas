 ...
 *
 */
public class PopupCopyPaste extends JPopupMenu {
	...
	public PopupCopyPaste() {
		undoManager = new UndoManager();

		clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();

		jmenuItem_undo = new JMenuItem("Desfazer");
		...
		jmenuItem_cut = new JMenuItem("Cortar");
		...
		jmenuItem_copy = new JMenuItem("Copiar");
		...
		jmenuItem_paste = new JMenuItem("Colar");
		...
		jmenuItem_delete = new JMenuItem("Apagar");
		...
		jmenuItem_selectAll = new JMenuItem("Seleciona Tudo");
